...
define("ember-cli-keyboard-actions/function-resolver", ["exports", "ember-cli-keyboard-actions/keycode-map", "ember-cli-keyboard-actions/keycode-ranges"], function (exports, _emberCliKeyboardActionsKeycodeMap, _emberCliKeyboardActionsKeycodeRanges) {
  /**
  ...
  FunctionResolver.prototype.resolvePrettyName = function resolvePN(keyCode) {
    var prettyName = _emberCliKeyboardActionsKeycodeMap["default"][keyCode];
  ...
  FunctionResolver.prototype.resolveKeyRange = function resolveKR(keyCode) {
    ...
    if (keyCode in _emberCliKeyboardActionsKeycodeRanges["default"]) {
      ranges = _emberCliKeyboardActionsKeycodeRanges["default"][keyCode];
...
define("ember-cli-keyboard-actions/keycode-map", ["exports"], function (exports) {
  "use strict";
...
define("ember-cli-keyboard-actions/keycode-ranges", ["exports"], function (exports) {
  "use strict";
...
define("ember-cli-keyboard-actions/mixins/keyboard-actions", ["exports", "ember", "ember-cli-keyboard-actions/function-resolver"], function (exports, _ember, _emberCliKeyboardActionsFunctionResolver) {
  /**
  ...
  exports["default"] = _ember["default"].Mixin.create({
     ...
     * @returns {Boolean}
     */
    isChordPressed: _ember["default"].computed("chordState.ctrl", "chordState.alt", "chordState.shift", function () {
     ...
     */
    refreshChordState: function refreshChordState(event) {
      this.setProperties({
     ...
     * @returns {Boolean} - Used to continue/halt propagation
     */
    dispatchKeyFunction: function dispatchKeyFunction(keyCode, action) {
      /**
       ...
       */
      var functionResolver = new _emberCliKeyboardActionsFunctionResolver["default"](keyActions, this);
     ...
     * @returns {Boolean} - Used to continue/halt propagation
     */
    runKeyFunction: function runKeyFunction(fn, data) {
